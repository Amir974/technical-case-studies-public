...
Public-safe artifacts in this export draft include the main narrative, companion notes, support pages, synthetic examples, diagram assets, visual specs, and publication notes.
...
| [IMPLEMENTATION_EVIDENCE.md](IMPLEMENTATION_EVIDENCE.md) | Optional proof layer summarizing private implementation history by category. |
| [IMPLEMENTATION_ACTIVITY_LEDGER.md](IMPLEMENTATION_ACTIVITY_LEDGER.md) | Optional sanitized activity appendix with a representative trail, synthetic IDs, work-type classification, helper mapping, and component support. |
...
The Mermaid skeleton is [assets/architecture.mmd](assets/architecture.mmd). The designed visual specs are in [assets/diagram_specs.md](assets/diagram_specs.md). These images remain part of the private export draft until a separate publication review approves export.

## Optional Proof And Safety Appendix

The implementation evidence, activity ledger, claim review notes, and publication notes are optional proof/safety material. They exist for readers who want deeper credibility, claim discipline, and public/private-boundary context; they are not required for a first-pass read.
...
Private working material exists outside this public export draft to support internal review. It is not part of the public artifact map and should not be exported. Private proof ledgers remain private working material, not public artifacts.
...
This export draft does not include private source material, raw operational evidence, account data, contact data, exact internal identifiers, private commands, screenshots, generated images outside the reviewed diagram set, or implementation-specific access details.
