...
| [PUBLICATION_NOTES.md](PUBLICATION_NOTES.md) | Reader-facing publication context. |

## Proof / Appendix Files
...
No raw private evidence is stored in this folder. Private evidence remains outside the public artifact set and should not be copied into export.

## Future Export Considerations

- Re-run privacy scans before any public export.
- Replace or recreate screenshots rather than exporting private UI captures.
- Keep proof tables optional and avoid making the README a metadata wall.
- Confirm links after any folder move.
- Do not export draft-only notes unless publication review approves them.
